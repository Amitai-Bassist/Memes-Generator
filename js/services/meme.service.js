...
function setLineCoords(dx,dy,lineIdx){
    let xCoord = gMeme.lines[lineIdx].x + dx
    let yCoord = gMeme.lines[lineIdx].y + dy
    if (xCoord < 15) gMeme.lines[lineIdx].x = 15
    else if (xCoord > 485) gMeme.lines[lineIdx].x = 485
    else gMeme.lines[lineIdx].x = xCoord 
    if (yCoord < 15){
        gMeme.lines[lineIdx].y = 15
    } else if (yCoord > 485) gMeme.lines[lineIdx].y = 485
    else gMeme.lines[lineIdx].y = yCoord 
    if (yCoord < 40) gMeme.lines[lineIdx].align = 'top'
